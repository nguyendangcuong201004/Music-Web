...
var controller = __importStar(require("../../controllers/admin/singer.controller"));
...
route.post("/create", upload.single('avatar'), uploadCloud_middleware_1.uploadSingle, controller.createPost);
route.get("/edit/:singerId", controller.edit);
route.patch("/edit/:singerId", upload.single('avatar'), uploadCloud_middleware_1.uploadSingle, controller.editPatch);
route.get("/delete/:singerId", controller.deleteSinger);
exports.singerRoutes = route;
