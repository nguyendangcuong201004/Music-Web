...
var controller = __importStar(require("../../controllers/admin/account.controller"));
...
route.patch("/edit/:accountId", upload.single('avatar'), uploadCloud_middleware_1.uploadSingle, controller.editPatch);
