...
var setting_model_1 = __importDefault(require("../../models/setting.model"));
var auth_middleware_1 = require("../../middlewares/admin/auth.middleware");
var general = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var setting;
...
var generalPatch = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var settingObject, setting, newSetting;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                if (!(0, auth_middleware_1.checkPermission)(res, "settings_edit")) {
            ...
            case 1:
                ...
                return [4 /*yield*/, setting_model_1.default.updateOne({
                        _id: setting.id
                    }, settingObject)];
            case 2:
                _a.sent();
                return [3 /*break*/, 5];
            case 3:
                newSetting = new setting_model_1.default(settingObject);
